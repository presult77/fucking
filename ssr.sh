...
wget -O /usr/bin/add-ssr https://script.redssh.net/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://script.redssh.net/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://script.redssh.net/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
