...
cd /usr/bin
wget -O add-ws "https://script.redssh.net/add-ws.sh"
wget -O add-vless "https://script.redssh.net/add-vless.sh"
wget -O add-tr "https://script.redssh.net/add-tr.sh"
wget -O del-ws "https://script.redssh.net/del-ws.sh"
wget -O del-vless "https://script.redssh.net/del-vless.sh"
wget -O del-tr "https://script.redssh.net/del-tr.sh"
wget -O cek-ws "https://script.redssh.net/cek-ws.sh"
wget -O cek-vless "https://script.redssh.net/cek-vless.sh"
wget -O cek-tr "https://script.redssh.net/cek-tr.sh"
wget -O renew-ws "https://script.redssh.net/renew-ws.sh"
wget -O renew-vless "https://script.redssh.net/renew-vless.sh"
wget -O renew-tr "https://script.redssh.net/renew-tr.sh"
