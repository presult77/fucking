...
wget -O usernew "https://script.redssh.net/usernew.sh"
wget -O trial "https://script.redssh.net/trial.sh"
...
wget -O renew "https://script.redssh.net/renew.sh"
...
wget -O change-port "https://script.redssh.net/change.sh"
wget -O port-ssl "https://script.redssh.net/port-ssl.sh"
wget -O port-wg "https://script.redssh.net/port-wg.sh"
wget -O port-tr "https://script.redssh.net/port-tr.sh"
wget -O port-squid "https://script.redssh.net/port-squid.sh"
wget -O port-ws "https://script.redssh.net/port-ws.sh"
wget -O port-vless "https://script.redssh.net/port-vless.sh"
...
wget -O add-se "https://script.redssh.net/add-se.sh"
chmod +x se-add
chmod +x se-delport
chmod +x se-maxlogin
chmod +x se-menu
