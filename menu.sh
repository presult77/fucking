...
echo -e ""
echo -e "=========================-SSH-========================"
echo -e "* usernew      : Create SSH Account"
echo -e "* trial        : Generate SSH Trial Account"
echo -e "* renew        : Extending SSH Account Active Life"
echo -e "* hapus        : Delete SSH Account"
echo -e "* cek          : Check User Login SSH"
echo -e "* member       : Daftar Member SSH"
echo -e "* delete       : Delete User Expired SSH"
echo -e "* autokill     : Set up Autokill SSH"
echo -e "* ceklim       : Displays Users Who Do Multi Login SSH"
echo -e "* restart      : Restart Service Dropbear, Squid3 dan SSH"
echo -e ""
echo -e "===========================-Wireguard-========================="
...
echo -e "* cek-ws       : Check User Login Vmess"
